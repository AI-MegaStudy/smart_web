...
RAIN_WARNING_MESSAGE = "수확기 강수량 주의 필요"
_MODEL = None
...
class MLService:
    ...
    def create_prediction(self, owner_id: int, payload: dict) -> dict:
        ...
        safety_factor = 0.8 if features["oct_rainfall"] < 200 else 0.6
        ...
        warning_message = NORMAL_WARNING_MESSAGE if features["oct_rainfall"] < 200 else RAIN_WARNING_MESSAGE
